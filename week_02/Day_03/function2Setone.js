...
// CODE HERE 
let printParameter=(p1,p2)=>{console.log(`The first parameter is ${p1}. The second parameter is ${p2}`)};
...
function callback(firstName,lastName) {
    return fullName = `Hello , My full name is ${firstName} ${lastName}`
...
console.log(greeting("Marufa" , "Sumi"));
