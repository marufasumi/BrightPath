...
Write a one line function (give a name of your choice) with an implicit
 return that when the function is invoked,
 it will print: 'The first parameter is [parameter1].
  The second parameter is [parameter2]'.
*/

// CODE HERE 
const printParameter=(p1,p2)=>{console.log(`The first parameter is ${p1}. The second parameter is ${p2}`)};
...
// INVOKE 'GREETING FUNCTION' HERE
 ...
 greeting("Marufa","Sumi",(fullName) => console.log(`Hello my full name is ${fullName}`))
////////// PROBLEM 4 //////////
...
/* 
Now, timesFour is the new function (the inner function that was being returned when we invoked 'multiplyingFactory'
function).The number 3 that we passed in as a first number is now saved in the 'timesFour' function. 
...
Then invoke 'timesFour' again, passing in number 4.
