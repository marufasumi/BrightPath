...
//CODE HERE
function jsninja(str) {
        return str = " I am javascript ninja!"
...
printName("cameron");
//const printName1 =name1 => console.log(`$(name)`);
...
// basic syntax of arrow function : let functionName =(para1 , para2..)=>{statement}
let compareNums = (x,y)=>{
  if(x==y){
    return x,y;
  }else if(x>y){
...
function printAllNames(arrayName) {
...
*/
// String() method convert any Data type to string
//trim() mehtod remove any white space in string
// include() method check substring
...
function emailCheck (email){
  ...
  if(email.includes('@')){
    ...
    return "Must provide an valid email address";
  }

}

console.log(emailCheck("marufasumi081@gmail.com"));
...
//CODE HERE
 ...
 function totalChocklate(gold){
   return Math.round(gold/3);
  

 }

 let totalFrogs = totalChocklate(4);
...
let totalFrogs2 = totalChocklate2(10);
...
/*
  ...
  Given the functions and variables above, edit the arrays below to contain only the appropriate variable names
  (as strings).
*/
